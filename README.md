...
- [vrm2pmx_v0.1.13.exe](https://github.com/tinatsu-nomy/vrm2pmx/releases/download/v0.1.13/vrm2pmx_v0.1.13.exe)
...
- **法線平滑化** — 頂点統合（位置+UV キー）+ 法線平均化によるメッシュエッジの平滑化（UI から ON/OFF 切替可能、デフォルト OFF）
