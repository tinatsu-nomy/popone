...
- **同期フォールバック**: UnityPackage / archive（多段 UI フローのため v0.2.27 では非同期対象外）
- **バックグラウンド**: VRM / FBX / PMX / PMD / OBJ / STL / DirectX .x
